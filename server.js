...
var allowed_keys = {
	"fcsfcsfcs":{
		allowed_hosts:["http://localhost:2000","http://fcsteaua.ro","http://www.fcsteaua.ro","http://flirting.chat","http://www.flirting.chat"]
	},
	"plmplmplm":{
...
var default_connection = io.use(function(socket,next){
	...
	var handshake_error = "";
	console.log("host:"+host+(allowed_keys[client_key].allowed_hosts.indexOf(host) == -1));
